    ...
    for src_mod in source.modules:
        ...
        for src_lesson in src_mod.lessons:
            new_lesson = CourseLesson(
                ...
                # Piano delle figure: la copia è sempre in un'altra lingua, quindi
                # fabbisogni (soggetti nella lingua del sorgente, need_id dal
                # soggetto), collegamenti e fotografia non si copiano: si
                # ricalcolano alla prima richiesta di Fase 3 della copia.
                figure_needs=None,
                figure_needs_status=None,
                figure_need_links=None,
                figure_assignment=None,
                content_attempts=0,
                content_tokens=None,
                content_error=None,
