...
Mermaid 11.x — pin `settings.mermaid_cdn_version` — per i diagrammi), questa
...
I vincoli Mermaid del prompt (tipi ammessi ed esclusi) sono derivati da
`figure_theme.MERMAID_ALLOWED_TYPES` / `MERMAID_EXCLUDED_TYPES` (D8, D10):
un riparatore che vietasse la 11.x sarebbe incoerente con il validatore.
