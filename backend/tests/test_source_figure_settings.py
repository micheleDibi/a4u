...
_DEFAULTS: dict[str, object] = {
    ...
    "figure_auto_fill_enabled": True,
    "figure_intro_sentence_enabled": True,
    "openai_figure_intro_model": "gpt-4.1-mini",
    "openai_figure_intro_reasoning_effort": None,
    "openai_figure_intro_max_tokens": 400,
