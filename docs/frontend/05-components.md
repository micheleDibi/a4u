...
- **I modelli sono anche il campione di GEOMETRIA** del tema: le loro
  etichette stanno dentro la tela (misurato in Chromium sul bbox reale,
  §18 del doc 17) e non vengono troncate dal `labelLimit` di Vega-Lite.
  Un modello nuovo con un'etichetta lunga fa fallire i test di geometria,
  che è il modo giusto per scoprirlo.
